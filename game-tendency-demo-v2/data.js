const testData = {
  ...
  questions: {
    q1: {
      ...
      question: "게임을 시작했습니다.",
      answers: [
        { text: "저 멀리 보이는 동굴이 수상해 보이는걸?", scores: { exploration: 3, experimentation: 1 }, next: "q2a" },
        { text: "이야기를 시작할 것만 같은 NPC가 있어.", scores: { relationship: 2, narrative: 2 }, next: "q2b" },
        { text: "스킬은 어떻게 배우는거지? 장비는 어떻게 구해?", scores: { growth: 3, challenge: 1 }, next: "q2a" },
        { text: "너 강해 보이네. 한판 붙어볼까?", scores: { challenge: 3, experimentation: 1 }, next: "q2b" }
      ]
    },
    q2a: {
