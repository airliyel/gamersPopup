const testData = {
  ...
  combinations: {
    "action-social": {title:"전장을 함께 누비는 돌격대장",character:"클로스",game:"Hollow Knight",description:"동료들과 함께 시련에 뛰어들고, 긴장과 환호를 나누며 위기를 극복하는 플레이어입니다.",keywords:["협동","전투","용기","호흡"],image:"assets/characters/action-social.svg",matchReason:"두려움 속에서도 동료와 함께 전장에 뛰어드는 클로스의 모습이 액션성과 유대감을 동시에 보여줍니다."},
    "action-mastery": {title:"한계에 도전하는 결투가",character:"호넷",game:"Hollow Knight: Silksong",description:"자신의 조작과 판단을 시험하는 최고의 시련 자체를 즐깁니다. 패배는 다음 도전을 위한 연습입니다.",keywords:["보스전","피지컬","집중","재도전"],image:"assets/characters/action-mastery.svg",matchReason:"호넷은 빠른 움직임과 정교한 전투 기술로 끊임없이 자신의 한계를 시험하는 인물입니다."},
    "action-achievement": {title:"업적을 사냥하는 정복자",character:"말론",game:"Stardew Valley",description:"위험한 목표일수록 직접 돌파해 성취를 증명하고 싶어 합니다. 강한 보상과 어려운 기록에 끌립니다.",keywords:["토벌","업적","보상","정복"],image:"assets/characters/action-achievement.svg",matchReason:"말론은 위험한 몬스터 토벌을 기록과 보상으로 연결하며 행동과 성취를 함께 추구합니다."},
    "action-immersion": {title:"세계에 뛰어드는 모험가",character:"기사",game:"Hollow Knight",description:"험난한 세계를 관찰만 하기보다 자신의 두 손으로 헤쳐 나가며 그 안의 이야기를 경험합니다.",keywords:["모험","전투","세계관","여정"],image:"assets/characters/action-immersion.svg",matchReason:"기사는 말보다 행동으로 신성둥지를 헤쳐 나가며 세계의 비밀을 직접 경험합니다."},
    "action-creativity": {title:"전투를 놀이로 바꾸는 트릭스터",character:"메타톤 EX",game:"UNDERTALE",description:"정해진 방식에 머물지 않고 화려하고 독특한 방법으로 챌린지를 자신만의 무대로 바꿉니다.",keywords:["변칙","액션","연출","실험"],image:"assets/characters/action-creativity.svg",matchReason:"메타톤 EX는 전투를 화려한 쇼로 바꾸며 자신만의 방식으로 위기를 돌파합니다."},
    "social-mastery": {title:"합을 맞추는 전략적 조력자",character:"퀴렐",game:"Hollow Knight",description:"피드백과 역할 분담을 통해 동료와 함께 성장하고, 완벽한 호흡으로 난관을 넘을 때 희열을 느낍니다.",keywords:["협력","전략","피드백","성장"],image:"assets/characters/social-mastery.svg",matchReason:"퀴렐은 지식과 전투력을 바탕으로 동료와 완벽하게 호흡하며 난관을 해결합니다."},
    "social-achievement": {title:"성과를 빛내는 스타 플레이어",character:"알렉스",game:"Stardew Valley",description:"사람들과 활발히 교류하면서도 뛰어난 기록과 성취를 인정받고 싶어 하는 플레이어입니다.",keywords:["경쟁","랭킹","인정","목표"],image:"assets/characters/social-achievement.svg",matchReason:"알렉스는 사람들의 응원 속에서 자신의 실력과 성취를 증명하고 싶어 합니다."},
    "social-immersion": {title:"관계를 살아가는 롤플레이어",character:"랄세이",game:"DELTARUNE",description:"게임 속 인물들과 깊은 관계를 맺고, 그 세계의 한 사람으로 살아가는 경험을 소중히 여깁니다.",keywords:["관계","대화","공감","롤플레잉"],image:"assets/characters/social-immersion.svg",matchReason:"랄세이는 관계를 소중히 여기며 동료들과 함께 다크 월드의 이야기를 살아갑니다."},
    "social-creativity": {title:"취향을 나누는 크리에이터",character:"에밀리",game:"Stardew Valley",description:"자신만의 독창적인 스타일을 만들고, 다른 사람과 공유하며 새로운 반응을 얻는 것을 즐깁니다.",keywords:["공유","스타일","창작","커뮤니티"],image:"assets/characters/social-creativity.svg",matchReason:"에밀리는 자신의 독특한 취향과 창작물을 주변 사람들과 자연스럽게 나눕니다."},
    "mastery-achievement": {title:"완벽을 반복하는 완주자",character:"프리스크",game:"UNDERTALE",description:"완벽한 하나의 플레이를 위해 몇 번이고 도전하며, 결국 스스로 세운 목표를 끝까지 달성합니다.",keywords:["완주","숙련","반복","완벽"],image:"assets/characters/mastery-achievement.svg",matchReason:"프리스크는 반복되는 선택과 도전을 통해 원하는 결말을 끝까지 완성할 수 있습니다."},
    "mastery-immersion": {title:"세계의 진실을 푸는 해석자",character:"마법사",game:"Stardew Valley",description:"숨겨진 설정과 단서를 파헤쳐 세계관과 서사를 빈틈없이 이해하려는 플레이어입니다.",keywords:["분석","설정","추리","세계관"],image:"assets/characters/mastery-immersion.svg",matchReason:"마법사는 세계의 보이지 않는 규칙을 연구하며 계곡의 신비와 설정을 탐구합니다."},
    "mastery-creativity": {title:"시스템을 비트는 연구자",character:"샌즈",game:"UNDERTALE",description:"게임의 규칙을 깊이 이해한 뒤, 그 구조를 이용해 새롭고 독창적인 플레이를 만들어 냅니다.",keywords:["시스템","실험","전략","변칙"],image:"assets/characters/mastery-creativity.svg",matchReason:"샌즈는 게임의 규칙과 시간 구조를 이해하고 이를 독특한 방식으로 활용합니다."},
    "achievement-immersion": {title:"이야기를 수집하는 기록가",character:"건터",game:"Stardew Valley",description:"서브퀘스트와 수집 요소를 빠짐없이 모으며, 세계의 이야기를 하나의 완성된 기록으로 남깁니다.",keywords:["수집","기록","서브퀘스트","완성"],image:"assets/characters/achievement-immersion.svg",matchReason:"건터는 수집한 유물과 기록을 통해 계곡의 세계와 역사를 완성해 나갑니다."},
    "achievement-creativity": {title:"목표를 새롭게 푸는 개척자",character:"라이너스",game:"Stardew Valley",description:"정석적인 길보다 독특한 플레이 방식으로 목표와 도전과제를 달성하는 데 큰 만족을 느낍니다.",keywords:["도전과제","자유","독창성","개척"],image:"assets/characters/achievement-creativity.svg",matchReason:"라이너스는 정해진 성공 방식 대신 자신만의 삶과 목표를 선택하는 인물입니다."},
    "immersion-creativity": {title:"세계에 흔적을 남기는 방랑자",character:"코니퍼",game:"Hollow Knight",description:"다양한 환경을 찾아다니며 세계에 녹아들고, 자신만의 시선과 흔적을 그 안에 남기고 싶어 합니다.",keywords:["탐험","분위기","창작","발견"],image:"assets/characters/immersion-creativity.svg",matchReason:"코니퍼는 새로운 환경을 탐험하고 지도로 남기며 세계에 자신만의 흔적을 더합니다."}
  }
};
